# Todo: 
#  1 - do an earlier transformation adjusting different data formats into a common format
#  2 - copy data to S3 bucket / folder
import logging
class DataIngestionApp:
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(DataIngestionApp, self).__init__(*args, **kwargs)
